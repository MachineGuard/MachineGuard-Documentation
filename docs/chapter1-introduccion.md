...
| :--- | :--- | :--- | :--- | :--- |
| **Diego Seijas Vasquez** | u202210167 | Ingeniería de Software<br>Universidad Peruana de Ciencias Aplicadas | <img src="../assets/img/chapter-1/TeamMember/diegoseijas.jpeg" alt="Diego Seijas" width="100"/> | Estudiante de Ingeniería de Software orientado al desarrollo full-stack y al diseño de soluciones de extremo a extremo. Cuenta con experiencia en TypeScript, Next.js y React para el desarrollo web, Spring Boot y Java para servicios backend, y en el modelado y persistencia de datos con PostgreSQL, Prisma y Spring Data JPA. Ha desarrollado sistemas en producción que integran APIs REST de terceros (facturación electrónica y servicios de consulta), manejo de autenticación y autorización, y diseño de esquemas de base de datos con migraciones versionadas. Maneja Git, GitHub y GitFlow, modelado con Domain-Driven Design y documentación de APIs con OpenAPI/Swagger. Destaca por su capacidad de análisis, la organización del trabajo bajo metodologías ágiles y el compromiso con la entrega de un producto funcional y bien documentado. |
...
| **Camilla Leonor Espinoza Vivas** | u202214572 | Ingeniería de Software<br>Universidad Peruana de Ciencias Aplicadas | <img src="../assets/img/chapter-1/TeamMember/Camilla.jpg" alt="Camilla Espinoza" width="100"/> | Poseo conocimientos en Ingeniería de Software enfocados al desarrollo web full-stack, utilizando tecnologías como Angular, Spring Boot, Java, TypeScript, JavaScript, HTML5 y CSS3. Tengo experiencia en diseño de software orientado a objetos, arquitectura RESTful, modelado con diagramas de clases y consumo/documentación de APIs con Swagger. Además, manejo control de versiones con Git y GitHub, y cuento con habilidades en UX/UI, prototipado y trabajo bajo metodologías ágiles utilizando herramientas como Jira Software. |
| **Sandro Dinklange Arevalo** | u202313419 | Ingeniería de Software<br>Universidad Peruana de Ciencias Aplicadas | <img src="../assets/img/chapter-1/TeamMember/sandro.jpg" alt="Sandro Dinklange" width="100"/> | Soy un estudiante de Ingeniería de Software en la UPC especializado en desarrollo Full-Stack. Domino lenguajes como C++, C# y Python, y me destaco por mi proactividad y facilidad para trabajar en entornos colaborativos.. Aporte al equipo |
| **Jose Diego Bautista Rivera** | u202310949 | Ingeniería de Software<br>Universidad Peruana de Ciencias Aplicadas | <img src="../assets/img/chapter-1/TeamMember/diego.jpg" alt="Jose Bautista" width="100"/> | Estudiante de la carrera de Ingeniería de Software, con gran interés en el desarrollo y diseño de base de datos. Trabajar soluciones a problemas reales con software limpio y eficiente. Con buenas prácticas de programación, trabajo en equipo y en constante aprendizaje. Con habilidades en MySQL y gestión de base de datos, Git, GitFlow, DDD, trabajo en equipo, compromiso y aprendizaje autónomo. |
| **Jhoan Darner Janampa Gutierrez** | u202323319 | Ingeniería de Software<br>Universidad Peruana de Ciencias Aplicadas | <img src="../assets/img/chapter-1/TeamMember/Jhoan.jpeg" alt="Jhoan Janampa" width="100"/> | Estudiante de Ingeniería de Software apasionado por el desarrollo de aplicaciones y soluciones tecnológicas innovadoras. Interesado en áreas como inteligencia artificial, desarrollo web y creación de sistemas eficientes con habilidades en MySQL y gestión de base de datos, Git, GitFlow, DDD, trabajo en equipo, compromiso y aprendizaje autónomo. |
